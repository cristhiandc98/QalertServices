...
public class PaymentDaoImpl implements IPaymentDao{
    ...
    public PaymentGetResponse get(String paymentCode) {
        ...
        for (Map<String,Object> map : resultset) {
            model.setUserId(DbUtil.getLong(map, "user_id"));
            ...
            model.setStatus(new StatusResponse());
            model.getStatus().setStatusId(DbUtil.getInt(map, "status_id"));
            model.getStatus().setStatusCode(DbUtil.getString(map, "status_code"));
            model.getStatus().setStatusName(DbUtil.getString(map, "status_name"));
        }
